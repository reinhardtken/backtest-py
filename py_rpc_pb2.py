...
_STOCKREQ = _descriptor.Descriptor(
  name='StockReq',
  full_name='proto.StockReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='proto.StockReq.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOCKRSP = _descriptor.Descriptor(
  name='StockRsp',
  full_name='proto.StockRsp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error', full_name='proto.StockRsp.error', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
StockReq = _reflection.GeneratedProtocolMessageType('StockReq', (_message.Message,), {
  'DESCRIPTOR' : _STOCKREQ,
  '__module__' : 'py_rpc_pb2'
  # @@protoc_insertion_point(class_scope:proto.StockReq)
  })
_sym_db.RegisterMessage(StockReq)

StockRsp = _reflection.GeneratedProtocolMessageType('StockRsp', (_message.Message,), {
  'DESCRIPTOR' : _STOCKRSP,
  '__module__' : 'py_rpc_pb2'
  # @@protoc_insertion_point(class_scope:proto.StockRsp)
  })
...
_STOCKSIGNAL = _descriptor.ServiceDescriptor(
  name='StockSignal',
  full_name='proto.StockSignal',
  file=DESCRIPTOR,
  index=3,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Update',
    full_name='proto.StockSignal.Update',
    index=0,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_STOCKSIGNAL)

DESCRIPTOR.services_by_name['StockSignal'] = _STOCKSIGNAL
