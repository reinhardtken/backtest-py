...
class StockSignalStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Update = channel.unary_unary(
        '/proto.StockSignal/Update',
        request_serializer=py__rpc__pb2.StockReq.SerializeToString,
        response_deserializer=py__rpc__pb2.StockRsp.FromString,
        )


class StockSignalServicer(object):
  """定义Hello服务
  """
...
def add_StockSignalServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Update': grpc.unary_unary_rpc_method_handler(
          servicer.Update,
          request_deserializer=py__rpc__pb2.StockReq.FromString,
          response_serializer=py__rpc__pb2.StockRsp.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'proto.StockSignal', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
